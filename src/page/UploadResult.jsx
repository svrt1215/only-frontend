...
//   const [results, setResults] = useState([{ year: '', total: '', status: '' }]);
...
//     setResults([...results, { year: '', total: '', status: '' }]);
//   };
...
//                   <input
//                     type="text"
//                     placeholder="Total (e.g. 998/1400)"
//                     className="input input-bordered min-w-[130px]"
//                     value={item.total}
//                     onChange={(e) => handleResultChange(index, 'total', e.target.value)}
//                   />
//                   <select
